...
1. [capas-contexto.md](capas-contexto.md) — el modelo del sistema: cuatro capas, regla del ancla, aprendizaje, skills
2. [19-riel-kernel.md](19-riel-kernel.md) — reglas invariantes del coordinador (capa 0)
3. [04-nacimiento-agentes.md](04-nacimiento-agentes.md) — cómo nace (y se retira) un agente local
